...
from flask_wtf_honeypot.honeypot.fields import HoneyPotField, RANDOM_STYLES, HONEY_POT_PREFIX
from flask_wtf_honeypot.honeypot.test import WTFHoneyPotTestCase


class HoneyPotFieldTestCase(WTFHoneyPotTestCase):
    @patch('flask_wtf_honeypot.honeypot.fields.current_app')
    @patch('flask_wtf_honeypot.honeypot.fields.HoneyPotField.random')
...
class HoneyPotFieldRootTestCase(HoneyPotFieldTestCase):
    ...
    @patch('flask_wtf_honeypot.honeypot.fields.current_app')
    @patch('flask_wtf_honeypot.honeypot.fields.randint')
    @patch('flask_wtf_honeypot.honeypot.fields.HoneyPotField.random')
    ...
    @patch('flask_wtf_honeypot.honeypot.fields.choice')
    ...
    @patch('flask_wtf_honeypot.honeypot.fields.HoneyPotField.random')
    @patch('flask_wtf_honeypot.honeypot.fields.HoneyPotField._get_epoch')
...
class HoneyPotFieldProcessTestCase(HoneyPotFieldTestCase):
    ...
    @patch('flask_wtf_honeypot.honeypot.fields.HoneyPotField.reset_honeypot')
...
class HoneyPotFieldValidationTestCase(HoneyPotFieldTestCase):
    ...
    @patch('flask_wtf_honeypot.honeypot.fields.HoneyPotField.validate_time')
